...
※ もう一つのエンドポイントの種類としてメトリック インジェスト エンドポイントという、メトリックをデータ インジェスト パイプラインに取り込むエンドポイントが存在します。  
ただし、データ収集ルール作成時にはログ インジェスト エンドポイントとメトリック インジェスト エンドポイントが 1 つのエンドポイントとして扱われるため、本ブログ内ではログ インジェスト エンドポイントに言葉を集約してお話しします。 
